...
// SwiftyDrop
#define COCOAPODS_POD_AVAILABLE_SwiftyDrop
#define COCOAPODS_VERSION_MAJOR_SwiftyDrop 1
#define COCOAPODS_VERSION_MINOR_SwiftyDrop 0
#define COCOAPODS_VERSION_PATCH_SwiftyDrop 4
